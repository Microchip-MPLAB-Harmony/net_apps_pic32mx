...
-   **TCPIP Driver Layer**
    ...
    2.  **External ENC28j60 ethernet driver**
        ...
        TCP/IP ENC28j60 driver module selected for the external ethernet mac ENC28j60 device. For high MAC TX and RX performance DRV\_ENC28j60\_MAC\_TX\_DESCRIPTORS and DRV\_ENC28j60\_MAC\_RX\_DESCRIPTORS can be configured respectively more than the default descriptor value size "2". ![tcpip_pic32mx_project](GUID-D429DF0E-78E9-4226-8DBC-A1BFDC6F7B82-low.png)
    ...
    3.  **External ENCX24j600 ethernet driver**
        ...
        ![tcpip_pic32mx_project](GUID-A6F97E8B-3AED-4EB4-87F2-CE68EAF52BB0-low.png)
